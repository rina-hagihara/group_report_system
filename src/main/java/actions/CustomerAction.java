    ...
    public void create() throws ServletException, IOException {
        ...
        //CSRF対策 tokenのチェック
            ...
            CustomerView cv = new CustomerView(
                    ...
                    getRequestParam(AttributeConst.CUS_TEL),
                    getRequestParam(AttributeConst.CUS_ADDRESS),
                    toDate(getRequestParam(AttributeConst.CUS_MOVE_DAY)),
                    toNumber(getRequestParam(AttributeConst.CUS_PAY_FLAG)),
                    null,
                    null,
