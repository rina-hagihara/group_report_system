...
public abstract class ActionBase {
    ...
    protected void redirectReportIndex(ForwardConst action, ForwardConst command, Integer id)
            throws ServletException, IOException {
    ...
    protected void redirectMissionShow(ForwardConst action, ForwardConst command, Integer id)
            throws ServletException, IOException {
    ...
    protected LocalDateTime toDate(String strDate) {
