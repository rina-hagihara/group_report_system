...
public class MissionAction extends ActionBase {
    ...
    public void create() throws ServletException, IOException {
            ...
            MissionView mv = new MissionView(
                    ...
                    toDate(getRequestParam(AttributeConst.MIS_VISIT_START)),
                    toDate(getRequestParam(AttributeConst.MIS_VISIT_FINISH)),
                    getRequestParam(AttributeConst.MIS_TRACK_SIZE),
                    toDate(getRequestParam(AttributeConst.MIS_MOVE_START)),
                    toDate(getRequestParam(AttributeConst.MIS_MOVE_FINISH)),
                    toDate(getRequestParam(AttributeConst.MIS_PAY_DUE)),
                    null,
                    null,
