...
<c:set var="commAssignEmp" value="${ForwardConst.CMD_ASSIGN_EMP.getValue()}" />
                    ...
                    <tr class="row${status.count % 2}">
                        ...
                        <td>
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <a href="<c:url value='?action=${actMis}&command=${commAssignEmp}&emp_id=${employee.id}&mis_id=${mission.id}' />">アサイン</a>
                                </c:otherwise>
                            </c:choose>
                        </td>
                    </tr>
